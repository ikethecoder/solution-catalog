    ...
    'Set Rocket.Chat OAuth' : function (browser) {
      ...
      browser
        ...
        browser.element('css selector', 'h1.rc-modal__title', function(result){
            ...
            .setValueSlow("input[name='Accounts_OAuth_Custom-Esgw-id']", 'rocketchat')
            .setValueSlow("input[name='Accounts_OAuth_Custom-Esgw-secret']", process.env.OAUTH_CLIENTS_ROCKETCHAT_CLIENT_SECRET)

    ...
    'Set Rocket.Chat OAuth' : function (browser) {
      ...
      browser
        ...
        browser.element('css selector', 'h1.rc-modal__title', function(result){
            ...
            .waitForElementVisible("input[name='Accounts_OAuth_Custom-Esgw-id']").setValueSlow("input[name='Accounts_OAuth_Custom-Esgw-id']", 'rocketchat')
            .waitForElementVisible("input[name='Accounts_OAuth_Custom-Esgw-secret']").setValueSlow("input[name='Accounts_OAuth_Custom-Esgw-secret']", process.env.OAUTH_CLIENTS_ROCKETCHAT_OAUTH2_CLIENT_SECRET)

...
canzea --config_git_commit --template=blocks/consul/docker/canzea-config.json /root/.ecosystem-catalog/config.json

canzea --config_git_commit --template=blocks/consul/docker/config/consul.service /etc/systemd/system/multi-user.target.wants/consul.service

...
export _DATA=`cat /etc/pki/tls/certs/logstash-forwarder.crt64` && canzea --lifecycle=wire --solution=consul --action=add_keyvalue --args='{"key":"certs/logstash","value":"{{_DATA}}"}'

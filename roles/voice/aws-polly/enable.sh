...
canzea --lifecycle=wire --solution=ecosystem --action=config --args='{"source":"roles/voice/aws-polly/config/aws-credentials.txt", "target":"/var/local/aws/.aws/credentials", "tracking":false}'

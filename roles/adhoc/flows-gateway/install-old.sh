...
su -l pm2user -c "(cd flows-gateway && git clone https://github.com/ikethecoder/node-red-contrib-canzea-elasticsearch.git)"

su -l pm2user -c "(cd flows-gateway && npm install ./node-red-contrib-canzea-elasticsearch)"
